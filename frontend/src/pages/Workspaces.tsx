      ...
      <div className="space-y-3 animate-in fade-in-0 slide-in-from-top-2">
        ...
        <div className="flex items-end justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground">List, create, rename, and delete.</p>
          </div>
            ...
            <Dialog open={createOpen} onOpenChange={setCreateOpen}>
              ...
              <DialogContent>
                ...
                <div className="space-y-2">
                  <Input placeholder="Workspace name" value={createName} onChange={(e) => setCreateName(e.target.value)} />
                </div>
                <DialogFooter>
          ...
          <div className="space-y-2">
            {items.map((ws, i) => (
              <div key={(ws.slug || 'ws') + i}
                className="rounded-md border bg-card/50 hover:bg-accent/10 transition px-3 py-3 flex items-center justify-between">
